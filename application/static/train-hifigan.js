...
let SECONDS_PER_ITERATION_PER_SECOND = 0.4;
...
// Epochs
low_epoch_threshold = 150;
medium_epoch_threshold = 300;
high_epoch_threshold = 500;
...
document.getElementById("pretrained_model_g").addEventListener("change", showEpochsLabel, false);
showEpochsLabel();

// Checkpoints
function showCheckpoints(dataset){
    select = document.getElementById("checkpoint_iteration");
    // Delete options
